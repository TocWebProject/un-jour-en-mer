            ...
            <div class="container pt-1">
                ...
                <div ref="infoFirstSection" class="info-first-section">
                  ...
                  <p ref="paragraphHome" class="paragraph">
                      Venez prendre l'air sur notre navire<br>
                      Vivez des excursions inoubliables<br> en Bretagne et à la voile.
                  </p>
                ...
                <div class="info-a-propos">
                    ...
                    <div class="col-6">
                      <div ref="infoApropos" class="info-a-propos_text">
                          <h3 class="heading-3-a-propos mt-4">
                          Victor et Melen, nos deux skippers diplômés ont navigués sur toutes les mers du globe.
                          </h3>
                          <p class="paragraph">
